...
const items = [
  {
    label: "Posts",
    widgetSrc: "${config_account}/widget/Components.Profile.Tab.Posts",
    icon: "bi bi-newspaper",
  },
  {
    label: "Videos",
    widgetSrc: "${config_account}/widget/Components.Profile.Tab.Videos",
    icon: "bi bi-camera-video",
  },
  {
    label: "Photos",
    widgetSrc: "${config_account}/widget/Components.Profile.Tab.Photos",
    icon: "bi bi-image",
  },
  {
    label: "Widgets",
    widgetSrc: "${config_account}/widget/Components.Profile.Tab.Widgets",
    icon: "bi bi-code-slash",
  },
  {
    label: "NFTs",
    widgetSrc: "${config_account}/widget/Components.Profile.Tab.NFTs",
    icon: "bi bi-wallet2",
  },
];
