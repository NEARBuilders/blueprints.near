const { Root } = VM.require("${config_account}/widget/Profile.Pixel.Root") || {
  Root: () => <></>,
};
...
const { FollowStats } = VM.require("${config_account}/widget/Components") || {
  FollowStats: () => <></>,
};

const { SocialSDK } = VM.require("${config_account}/widget/sdk.social") || {
  SocialSDK: {},
};
...
return (
  ...
  >
    ...
    <ContentContainer className="container-xl">
      <ProfileInfoContainer>
        ...
        <div className="d-flex align-items- flex-wrap gap-2">
          {context.accountId === accountId ? (
            <Widget
              src="${config_account}/widget/Components.EditModal"
              loading=""
              props={{
                theme: theme,
                accountId: accountId,
        ...
        <div>
          ...
          <Widget
            src="${config_account}/widget/StarredApplications"
            loading=""
            props={{
              accountId: accountId,
            }}
      ...
      <TabsContainer>
        <Widget
          src="${config_account}/widget/Components.Pixel.Tabs"
          loaidng=""
          props={{ accountId }}
        />
      </TabsContainer>
