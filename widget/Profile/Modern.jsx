const { Root } = VM.require("${config_account}/widget/Profile.Modern.Root") || {
  Root: () => <></>,
};
...
const { LinkIcon, CopyIcon } = VM.require("${config_account}/widget/Icons") || {
  LinkIcon: () => <></>,
  CopyIcon: () => <></>,
};
...
return (
  <Root theme={theme} font={font} activeColor={activeColor}>
    ...
    <div className="position-relative overflow-hidden">
      <Widget
        src="${config_account}/widget/Components.Profile.Tabs"
        loading=""
